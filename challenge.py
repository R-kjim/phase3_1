...
#function that sorts a list of tuples by values of a key in the tuple
def sort_by_age(list_of_tuples):
    return sorted(list_of_tuples, key=lambda item:item[1])

#example
print(sort_by_age([("age",25),("age",85),("age",35),("age",32)]))
...
#example
print(merge_dicts({"a":2,"b":3,"c":4},{"b":2,"c":10,"d":9}))
...
#example
subaru=Car("Subaru","Forster",2016)
subaru.display_info()